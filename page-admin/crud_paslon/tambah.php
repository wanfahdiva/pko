...
if (isset($_POST['simpan'])) {
    ...
    $cek = mysqli_query($conn, "SELECT * FROM paslon WHERE no_paslon='$nopas'") or die(mysqli_error($conn));
    if (mysqli_num_rows($cek) == 0) {
        $sql = mysqli_query($conn, "INSERT INTO paslon (id,no_paslon,ketua,wk1,wk2,visi,misi,program,gambar) VALUES('','$nopas','$ketua','$wk1','$wk2','$visi','$misi','$program','$gambar')");
        if ($sql) {
        ...
        echo '<script>alert("No Paslon Sudah Terdaftar.");</script>';
    }
}
...
<head>
    ...
    <title>PKO Admin - Tambah Palon</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-center mb-4">
                        <h4 class="m-0 font-weight-bold text-primary align-items-center">Tambah Data Paslon</h4>
                    </div>
                        ...
                        <div class="card-body">
                            <form action="" method="POST" enctype="multipart/form-data">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" class="form-control" required id="no_paslon" name="no_paslon">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="ketua" class="col-sm-2 col-form-label">Ketua</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" required id="ketua" name="ketua">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="wk1" class="col-sm-2 col-form-label">wakil 1</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" required id="wk1" name="wk1">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="wk2" class="col-sm-2 col-form-label">wakil 2</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" required id="wk2" name="wk2">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="visi" class="col-sm-2 col-form-label">Visi</label>
                                    <div class="col-sm-10">
                                        <textarea class="form-control" required id="visi" name="visi" aria-label="With textarea"></textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="misi" class="col-sm-2 col-form-label">Misi</label>
                                    <div class="col-sm-10">
                                        <textarea class="form-control" required id="misi" name="misi" aria-label="With textarea"></textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="program" class="col-sm-2 col-form-label">Program</label>
                                    <div class="col-sm-10">
                                        <textarea class="form-control" required id="program" name="program" aria-label="With textarea"></textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
