...
if (isset($_POST['simpan'])) {
	...
	$cek = mysqli_query($conn, "SELECT * FROM guru WHERE nama='$nama'") or die(mysqli_error($conn));
	if (mysqli_num_rows($cek) == 0) {
		$sql = mysqli_query($conn, "INSERT INTO guru (id,nama,password,sesi) VALUES('','$nama','$password','$sesi')");
		if ($sql) {
			echo '<script>alert("Berhasil menambahkan data."); document.location="../data_guru";</script>';
		} else {
...
<head>
	...
	<title>PKO Admin - Tambah Guru</title>
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div class="d-sm-flex align-items-center justify-content-center mb-4">
						<h4 class="m-0 font-weight-bold text-primary align-items-center">Tambah Data Guru</h4>
					</div>
						...
						<div class="card-body">
							<form action="" method="POST">
								...
								<div class="form-group row">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" required id="pass" placeholder="password" name="password" value="<?php echo substr(str_shuffle($permitted_chars), 0, 8); ?>">
									</div>
								</div>
								<div class="form-group row">
									<label for="sesi" class="col-sm-2 col-form-label">Sesi</label>
									<div class="col-sm-10">
										<input type="text" class="form-control" required id="sesi" placeholder="sesi" name="sesi">
									</div>
								</div>
