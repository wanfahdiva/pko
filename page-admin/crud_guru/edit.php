...
if (isset($_POST['simpan'])) {
	...
	$ubah = mysqli_query($conn, "UPDATE guru set nama='$nama', password='$password', pilihan='$pilihan', sesi='$sesi' where id='$id'");
	if ($ubah) {
		echo '<script>alert("Berhasil Mengubah data."); document.location="../data_guru";</script>';
	} else {
...
<head>
	...
	<title>PKO Admin - Edit Guru</title>
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div class="d-sm-flex align-items-center justify-content-center mb-4">
						<h4 class="m-0 font-weight-bold text-primary align-items-center">Edit Data Guru</h4>
					</div>
							...
							<?php while ($d = mysqli_fetch_assoc($data)) { ?>
								<form action="" method="POST">
									...
									<div class="form-group row">
										...
										<div class="col-sm-10">
											<input type="text" class="form-control" required id="nama" placeholder="nama" name="nama" value="<?php echo mysqli_real_escape_string($conn, $d['nama']); ?>">
										</div>
									</div>
									<div class="form-group row">
										<label for="pass" class="col-sm-2 col-form-label">Password</label>
										<div class="col-sm-10">
											<input type="text" class="form-control" required id="pass" placeholder="password" name="password" value="<?php echo mysqli_real_escape_string($conn, $d['password']); ?>">
										</div>
									</div>
									<div class="form-group row">
										<label for="sesi" class="col-sm-2 col-form-label">Sesi</label>
										<div class="col-sm-10">
											<input type="text" class="form-control" required id="sesi" placeholder="sesi" name="sesi" value="<?php echo mysqli_real_escape_string($conn, $d['sesi']); ?>">
										</div>
									</div>
									<div class="form-group row">
										<label for="pilihan" class="col-sm-2 col-form-label">Pilihan</label>
										<div class="col-sm-10">
											<input type="password" class="form-control" id="pilihan" placeholder="pilihan" name="pilihan" value="<?php echo mysqli_real_escape_string($conn, $d['pilihan']); ?>">
										</div>
									</div>
									<div class="form-group row float-right">
										<div class="col-sm-12 mt-2">
											<button type="submit" class="btn btn-primary mx-1" name="simpan">Ubah</button>
											<a href="../data_guru" class="btn btn-secondary mx-1">Kembali</a>
										</div>
									</div>
								</form>
							<?php
