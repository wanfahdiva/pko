...
if (isset($_POST['simpan'])) {
	$nama_sesi = mysqli_real_escape_string($conn, $_POST['nama']);
	...
	$cek = mysqli_query($conn, "SELECT * FROM sesi WHERE nama_sesi='$nama_sesi'") or die(mysqli_error($conn));
	if (mysqli_num_rows($cek) == 0) {
		$sql = mysqli_query($conn, "INSERT INTO sesi(id,nama_sesi,mulai,akhir,hari) VALUES('','$nama_sesi','$mulai','$akhir','$hari')");
		if ($sql) {
			echo '<script>alert("Berhasil menambahkan data."); document.location="../data_sesi";</script>';
		} else {
			echo '<script>alert("Gagal melakukan proses tambah data.");</script>';
		}
	} else {
		echo '<script>alert("Sesi Sudah Terdaftar.");</script>';
	}
}
...
<head>
	...
	<title>PKO Admin - Tambah Sesi</title>
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div class="d-sm-flex align-items-center justify-content-center mb-4">
						<h4 class="m-0 font-weight-bold text-primary align-items-center">Tambah Data Sesi</h4>
					</div>
					...
					<div class="card shadow mb-4" id="stringpass">
						<div class="card-header py-3">
							...
							<div class="row m-0">
								<p class="m-0 font-weight-200 text-gray align-items-center">
									format penulisan waktu "<p class="m-0 font-weight-bold text-warning">10:00</p>"
								</p>
							</div>
						</div>
						<div class="card-body">
							<form action="" method="POST">
								...
								<div class="form-group row">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" required id="mulai" name="mulai">
									</div>
								</div>
								<div class="form-group row">
									<label for="akhir" class="col-sm-2 col-form-label">Jam akhir</label>
									<div class="col-sm-10">
										<input type="text" class="form-control" required id="akhir" name="akhir">
									</div>
								</div>
								<div class="form-group row">
