                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-4 text-center">
                            <form action="cetak_siswa" method="post" target="_blank">
                                <h5>Cetak Data Siswa
                                </h5>
                                <button type="submit" class="btn btn-sm btn-primary" style="width: 70%;"><i class="fa fa-print"></i> Cetak</>
                            </form>
                        </div>
                        <div class="col-4 text-center">
                            <form action="cetak_guru" method="post" target="_blank">
                                <h5>Cetak Data Guru
                                </h5>
                                <button type="submit" class="btn btn-sm btn-primary" style="width: 70%;"><i class="fa fa-print"></i> Cetak</>
                            </form>
                        ...
                        <div class="col-4 text-center">
                            <form action="cetak_laporan" method="post" target="_blank">
                                <h5>Cetak Laporan Pemilihan
                                </h5>
                                <button type="submit" class="btn btn-sm btn-primary" style="width: 70%;"><i class="fa fa-print"></i> Cetak</>
                            </form>
                        </div>
